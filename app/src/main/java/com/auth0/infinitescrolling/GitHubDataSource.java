...
public class GitHubDataSource extends PageKeyedDataSource<String, JobModel> {
    ...
    public void loadInitial(@NonNull LoadInitialParams<String> params, @NonNull final LoadInitialCallback<String, JobModel> callback) {
        ...
        gitHubApi.getJobs(pageCount).enqueue(new Callback<List<JobModel>>() {
            @Override
            public void onResponse(@NotNull Call<List<JobModel>> call, @NotNull Response<List<JobModel>> response) {
            ...
            @Override
            public void onFailure(@NotNull Call<List<JobModel>> call, @NotNull Throwable t) {
